const TEMPLATES = [
  {
    ...
    label: "Arraignment",
    description:
      "Classic LSDA formal charge presentation with sentencing options and bail recommendations.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Enhanced charging document with case caption, per-count justifications, and prayer for relief.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  },
  {
    ...
    label: "Expungement",
    description:
      "Motion to seal or expunge prior criminal record with supporting motion text.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Negotiated plea with guilty charges, dismissals, and sentencing terms.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Nolle prosequi filing with dismissal reasoning and supporting grounds.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "General-purpose motion with dynamic numbered sections. Civil or criminal, prosecution or defense.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Formal notice entering an attorney as counsel of record for a client in a civil or criminal matter.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
  ...
  },
  {
    ...
    label: "Appeal Brief",
    description:
      "Appellate brief for the Second Court of Appeal with dynamic sections and parties.",
    icon: (
      <svg
        className="h-5 w-5"
        fill="none"
